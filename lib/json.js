...
exports.GlobalConfig = {
    ...
    title: 'Famo.us中文社区',
    //网站名称
    url: 'http://www.cfamous.cn',
    logo: '/static/img/logo.png',
    email: '',
    beian: '',
    description: 'Famo.us中文社区',
    //网站副标题
    metatitle: '',
    //Meta标题
    metadesc: '',
    //Meta描述
    keywords: 'Famous,Famo.us,JavaScript框架,3D特效,iOS开发,iPad开发,Android开发,HTML5开发,手机网站开发，手机应用开发，JavaScript,Apple,Android,developer,iOS,iPhone,iPad,iPod ,招聘,JavaScript程序员,移动应用外包,JavaScript面试',
